    ...
    <el-row>
      ...
      <el-col :span="12">
        <div class="right">
          ...
          <el-row>
            <el-button size="medium"  @click="addInOrder" class="btn-operate btn-buy">立即购买</el-button>
             <el-button size="medium" @click="addInCart" type="success" icon="el-icon-shopping-cart-full" class="btn-operate btn-cart">加入购物车</el-button>
          </el-row>
          <el-row class="banner-state">
